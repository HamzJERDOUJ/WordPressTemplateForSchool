...
if ( ! function_exists( 'dashy_default_theme_options' ) ) :
	...
	function dashy_default_theme_options() {
		...
		//copyright
		$defaults['dashy_footer_copyright']        		=  __('<p>Copyright © 2021  All Rights Reserved</p>','dashy');
			
		//powered by

		$defaults['dashy_footer_poweredby']        		=  __('<p>Designed by : Hamza Jerdouj, Mohammed Ezzahi, Salma Halla & Ayoub Hamroudi
 </p>','dashy');
